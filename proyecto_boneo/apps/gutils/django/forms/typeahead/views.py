...
from proyecto_boneo.apps.gutils.django.shortcuts import render_to_json_response
from proyecto_boneo.apps.gutils.django.forms.typeahead.lookups import REGISTERED_LOOKUPS
...
class TypeaheadAddModelView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.get_template_name(lookup), context)
