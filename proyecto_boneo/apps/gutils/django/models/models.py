...
from proyecto_boneo.apps.gutils.django.middleware import get_current_user
...
class UserModel(models.Model):
    user_created = models.ForeignKey(User, related_name='+', blank=True, null=True, on_delete=models.PROTECT)
    user_updated = models.ForeignKey(User, related_name='+', blank=True, null=True, on_delete=models.PROTECT)
